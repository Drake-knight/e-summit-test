			...
			<div style={{ background: "#000026", color: "white", padding: "2rem" }}>
				<section>
					<div>
						...
						<br />
						With your permission, we may send you emails about our store, new products
						and other updates.
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 2 - CONSENT</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						How do you get my consent? When you provide us with personal information to
						complete a transaction, verify your credit card, place an order, arrange for
						a delivery or return a purchase, we imply that you consent to our collecting
						it and using it for that specific reason only. If we ask for your personal
						information for a secondary reason, like marketing, we will either ask you
						directly for your expressed consent, or provide you with an opportunity to
						say no. How do I withdraw my consent? If after you opt-in, you change your
						mind, you may withdraw your consent for us to contact you, for the continued
						collection, use or disclosure of your information, at anytime, by contacting
						us at
						<strong>sr_ecell@smail.iitm.ac.in</strong>
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 3 - DISCLOSURE</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						We may disclose your personal information if we are required by law to do so
						or if you violate our Terms of Service.
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 4 - PAYMENT</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						We use Razorpay for processing payments. We/Razorpay do not store your card
						data on their servers. The data is encrypted through the Payment Card
						...
						information is not saved. Our payment gateway adheres to the standards set
						by PCI-DSS as managed by the PCI Security Standards Council, which is a
						...
						information by our store and its service providers. For more insight, you
						may also want to read terms and conditions of razorpay on
						https://razorpay.com
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 5 - THIRD-PARTY SERVICES</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						processors, have their own privacy policies in respect to the information we
						are required to provide to them for your purchase-related transactions. For
						these providers, we recommend that you read their privacy policies so you
						...
						located in or have facilities that are located a different jurisdiction than
						...
						information may become subject to the laws of the jurisdiction(s) in which
						that service provider or its facilities are located. Once you leave our
						store’s website or are redirected to a third-party website or application,
						...
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 6 - SECURITY</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						circumstances, if any, we use and/or disclose it. If our store is acquired
						or merged with another company, your information may be transferred to the
