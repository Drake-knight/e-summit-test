...
const TNC = () => {
	return (
		<>
			<Navbar />
			<div style={{ background: "#000026", color: "white", padding: "2rem" }}>
				<section>
					<div>
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>OVERVIEW</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						This website is operated by E-Cell, IIT Madras. Throughout the site, the
						terms “we”, “us” and “our” refer to E-Cell, IIT Madras. E-Cell, IIT Madras
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 1 - ONLINE STORE TERMS</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 2 - GENERAL CONDITIONS</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						service is provided, without express written permission by us. The headings
						used in this agreement are included for convenience only and will not limit
						...
						on this site is at your own risk. This site may contain certain historical
						...
						right at any time to modify or discontinue the Service (or any part or
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 7 - OPTIONAL TOOLS</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						to your use of optional third-party tools. Any use by you of optional tools
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 8 - THIRD-PARTY LINKS</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						services of third-parties. We are not liable for any harm or damages related
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 9 - PERSONAL INFORMATION</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						clarify information in the Service or on any related website, including
						...
						website, should be taken to indicate that all information in the Service or
						on any related website has been modified or updated.
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 11 - PROHIBITED USES</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						indefinite periods of time or cancel the service at any time, without notice
						to you. You expressly agree that your use of, or inability to use, the
						...
						durability, title, and non-infringement. In no case shall E-Cell, IIT
						Madras, our directors, officers, employees, affiliates, agents, contractors,
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 13 - INDEMNIFICATION</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						You agree to indemnify, defend and hold harmless E-Cell, IIT Madras and our
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 14 - SEVERABILITY</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 15 - TERMINATION</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						using our site. If in our sole judgment you fail, or we suspect that you
						have failed, to comply with any term or provision of these Terms of Service,
						we also may terminate this agreement at any time without notice and you will
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 16 - ENTIRE AGREEMENT</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 17 - GOVERNING LAW</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						periodically for changes. Your continued use of or access to our website or
						the Service following the posting of any changes to these Terms of Service
						constitutes acceptance of those changes.
						<br />
						<br />
						<h2 style={{ fontSize: "2.5rem" }}>SECTION 19 - CONTACT INFORMATION</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						...
						<br />
						<br />
						<h2 id="refund-policy" style={{ fontSize: "2.5rem" }}>
							SECTION 20 - Refund Policy
						</h2>
						<br />
						<hr style={{ width: "90%" }} />
						<br />
						No money will be refunded once the transaction is successful. In case of
						transaction failure, the amount will be refunded back to the user&apos;s
						account within 7 days (from the transaction date).
						<br />
						<br />
					</div>
					<div class="shape-divider" data-style="2" data-color="#F8F9FA"></div>
				</section>
			</div>
			<Footer />
		</>
