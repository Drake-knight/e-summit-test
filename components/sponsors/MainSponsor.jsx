...
import jetBrains from "../../public/assets/sponsors/JetBrains.png";
...
import iitmic from "../../public/assets/sponsors/iitmic.png";
import iitmef from "../../public/assets/sponsors/iitmef.jpg";
import iitmaa_logo from "../../public/assets/sponsors/iitmaa_logo.jpg";
...
const imgMap = {
 ...
 iitmef : iitmef ,
 iitmic : iitmic ,
 iitmaa_logo : iitmaa_logo ,
};

export default function MainSponsor({ name, text, img, link }) {
	return (
		<>
