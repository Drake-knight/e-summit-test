			...
			<Flex
				...
				<Flex
					...
					<Flex direction="column" justify="center">
						<TimelineEvent icon="rocket" text="Launch" date="27th Feb"></TimelineEvent>
						<TimelineEvent
							icon="register"
							text="Registration Duration"
							date="27th Feb - 10th March"></TimelineEvent>
						<TimelineEvent
							icon="stopwatch"
							text="Round 0"
							date="10th March - 11th March"></TimelineEvent>
						<TimelineEvent
							icon="announce"
							text="Round 0 Results"
							date="15th March"></TimelineEvent>
						<TimelineEvent
							icon="ninja"
							text="Round 1-4"
							date="7th - 9th April (at IIT-M Campus)"
						/>

						<TimelineEvent icon="graduate" text="Final Results" date="9th April" />
					</Flex>
				</Flex>
			</Flex>
		</Box>
