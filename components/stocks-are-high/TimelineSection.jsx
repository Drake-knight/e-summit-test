				...
				<Flex
					...
					<Flex direction="column" justify="center">
						<TimelineEvent
							icon="rocket"
							text="Launch"
							date="10th March, Friday"></TimelineEvent>
						<TimelineEvent
							icon="stopwatch"
							text="Registration Deadline"
							date="22nd March, Wednesday"></TimelineEvent>
						<TimelineEvent icon="thumbsup" text="Competition commences" date="27th March, Monday" />
						<TimelineEvent icon="graduate" text="Results" date="7th April, Friday" />
					</Flex>
				</Flex>
			</Flex>
		</Box>
