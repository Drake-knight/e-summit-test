...
import HomeScreenIcon from "./HomeScreenIcon.js";
...
const PWAPrompt = ({
    ...
    const iOSClass = isiOS13AndUp ? styles.modern : styles.legacy; // Use styles.legacy for "legacy" class
        ...
        <Fragment>
            ...
            >
                <div className={`${styles.pwaPromptHeader} iOSPWA-header`}>
                    <p id="pwa-prompt-title" className={`${styles.pwaPromptTitle} iOSPWA-title`}>
                        {copyTitle}
                    </p>
                    <button
